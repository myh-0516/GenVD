...
python $ROOT/src/RQ2/unixcoder/run.py \
    --output_dir=$ROOT/results/RQ2/unixcoder/${DATASET} \
    --model_type=unixcoder \
    --tokenizer_name=$ROOT/pretrained_models/unixcoder-base \
    --model_name_or_path=$ROOT/pretrained_models/unixcoder-base \
    --do_train \
    --do_eval \
    --do_test \
